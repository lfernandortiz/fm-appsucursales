...
function initMap() {
	...
	google.maps.event.addListener(map, 'click', function() {
		console.log("registrando evento de cierre de infoWindow");
		infowindow.close();
	});
<<<<<<< HEAD
...
=======
	//edicion del DOM del objeto InfoWindow
	editCSSInfoWindowObject();
	
>>>>>>> 85bf36c338aa9ab8986c0e649dce2cb4502a4eb4
...
function editCSSInfoWindowObject(){
	//Desde aca se comienza la manipulacion del DOM del objeto Info Window
	//nos apoyamos de jQuery
	google.maps.event.addListener(infowindow, 'domready', function() {
		// Reference to the DIV that wraps the bottom of infowindow
...
}// fin del metodo editCSSInfoWindowObject
